...
- Do not deploy this prototype to restricted government networks without review of PII, retention, audit logging, network egress, approved OCR or vision provider usage, access control, monitoring, and distributed rate limiting.
