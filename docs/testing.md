...
- Queue preview: folder paths are hidden in queue rows, previews open from the queued file, preview close paths work, selection stays unchanged, and object URLs are revoked.
