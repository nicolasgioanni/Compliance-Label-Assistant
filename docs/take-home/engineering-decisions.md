...
| Expected application data is entered by the user. | No COLA API, database, or application-record source is required by the assignment. | The frontend provides fields for brand name, class or type, alcohol content, net contents, and government warning. |
