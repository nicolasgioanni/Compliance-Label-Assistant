...
| Deployment documentation | [../deployment/overview.md](../deployment/overview.md), [../deployment/frontend-vercel.md](../deployment/frontend-vercel.md), [../deployment/backend-render.md](../deployment/backend-render.md) | Documents dashboard settings because no Render or Docker config is checked in; CI validation is split across `backend-ci`, `frontend-ci`, and `repo-hygiene`. |
