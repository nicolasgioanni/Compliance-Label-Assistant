    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'CI runs separate frontend and backend jobs on pull requests and pushes to main, but it does not deploy the application.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'There is no checked-in Render config, Dockerfile, docker-compose file, Procfile, or CI-driven deployment workflow in the current repository.',
        ],
      },
      {
